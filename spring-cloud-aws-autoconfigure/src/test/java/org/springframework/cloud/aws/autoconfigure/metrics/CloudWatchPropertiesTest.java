...
public class CloudWatchPropertiesTest {
	...
	public void properties_notSet_shouldHaveDefaultValues() {
		AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(CloudWatchPropertiesConfiguration.class);
	...
	public void properties_set_shouldOverrideValues() {
		...
		applicationContext.getEnvironment().getPropertySources().addLast(new PropertiesPropertySource("test", properties));
