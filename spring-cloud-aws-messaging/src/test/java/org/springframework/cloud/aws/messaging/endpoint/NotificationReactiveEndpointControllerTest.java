...
import org.springframework.cloud.aws.messaging.endpoint.NotificationReactiveEndpointControllerTest.Config;
...
class NotificationReactiveEndpointControllerTest {
	...
	void subscribe_subscriptionConfirmationRequestReceived_subscriptionConfirmedThroughSubscriptionStatus()
		...
		// Act
		this.webTestClient.post().uri("/mySampleTopic")
